...
public class ExceptionCustomizada_1 {
    public static void main(String[] args) {
        ...
        System.out.println("\nCom ou sem exceção, o programa seguiu");
    ...
    public static void imprimirArquivoNoConsole(String nomeDoArquivo){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu um erro não esperado... Por favor, entre em contato com o suporte. " + ex.getMessage());
            ex.printStackTrace();
        }
    }
